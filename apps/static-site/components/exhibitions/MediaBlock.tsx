...
import { CanvasContext, MediaStrategy, useAnnotation, useThumbnail } from "react-iiif-vault";
          ...
          <Dialog.Panel className="relative flex h-full w-full flex-col justify-center overflow-y-auto overflow-x-hidden rounded bg-black">
            <div className="w-full flex-1">
              <iframe
                ...
                src={`https://www.youtube.com/embed/${media.youTubeId}?enablejsapi=1&origin=${getWindowHost()}&autoplay=1&modestbranding=1&rel=0`}

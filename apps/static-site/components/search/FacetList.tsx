    ...
    <div className="mb-8">
      ...
      <RefinementList
        ...
        classNames={{
          ...
          checkbox: "ml-2",
          label: "flex gap-2 mb-0.5 text-lg hover:bg-slate-100 rounded-lg cursor-pointer p-0.5",
          labelText: "overflow-ellipsis truncate",
          count: "rounded-full bg-slate-300 px-2 py-0.5 text-xs font-bold text-slate-800 self-center",
        }}
      />
    </div>
  );

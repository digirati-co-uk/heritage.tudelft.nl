...
<Illustration source="delf-kernreactor-01.json">
  Surfdrive > Publicaties Bestand: 01 - 134494 Reactor Instituut Delft van de TU Delft, ca. 1995. Foto: Fotografische
  dienst TUD. Via Stadsarchief Delft, 134494.
</Illustration>
...
<Illustration source="delf-kernreactor-02.json">
  Bestand: 02 - NL-HaNA_2.24.01.04_0_908-7220 Koninklijk bezoek op de tentoonstelling Het Atoom op Schiphol, 1957. Foto:
  Harry Pot. Collectie Nationaal Archief.
  https://www.nationaalarchief.nl/onderzoeken/fotocollectie/a9635644-d0b4-102d-bcf8-003048976d84?searchKey=ba75d72e3ae48c6876b8a3686ad72692
</Illustration>

## Reactor Instituut Delft

Al voordat de tentoonstelling op Schiphol plaatshad besloten de curatoren van de Technische Hogeschool dat het wenselijk was om in Delft een experimentele kernreactor te hebben voor onderwijs in de reactorkunde. Dat was in de jaren vijftig een nieuw en spannend vakgebied, het principe van de kernscheiding was pas net voor de oorlog ontdekt. Om deze initiatieven in goede banen te leiden werd aan de Technische Hogeschool de Commissie-Kramers ingesteld, die met verschillende organisatievoorstellen kwam voor de inrichting van een Delfts instituut. In 1955 werd zo voor het eerst een vakantieleergang (wat tegenwoordige _summerschool_ heet) in de ’Technologie en Constructie van Kernreactoren’ georganiseerd.
...
<Illustration source="delf-kernreactor-03.json">
  Bestand: 04 - SAETUD04012687_MMS-01 Bij een bezoek aan de TH in 1958 toont fysicus Ralph Kronig een maquette van de in
  aanbouw zijnde kernreactor aan koningin Juliana en prins Bernhard. Foto: Fotografische dienst TUD.
</Illustration>
...
<Illustration source="delf-kernreactor-04.json">
  Bestand: 05 - SAETUD04090355_MMS-01 Onderzoek naar de reactorkern in de barakken aan de Ezelsveldlaan. Foto:
  Fotografische dienst TUD.
</Illustration>
...
<Illustration source="delf-kernreactor-05.json">
  Bestand: 06 - 40976\*Foto TH Delft Aan de Ezelsveldlaan worden proeven gedaan met een ‘pile’ van grafiet. Foto: Foto:
  Fotografische dienst TUD. Via Stadsarchief Delft, 40976.
</Illustration>
...
<Illustration source="delf-kernreactor-06.json">
  Bestand: 07 - SAETUD04_04_0639_MMS-01 De glanzende koepel is bijna af. Foto: Fotografische dienst TUD.
</Illustration>
...
<Illustration source="delf-kernreactor-07.json">
  Bestand: 10 - SAETUD04_04_0640_MMS-01 Bij de oplevering staat de kernreactor nog helemaal aan de rand van Delft in de
  polder. Foto: Fotografische dienst TUD.
</Illustration>

---

_Dit artikel is eerder verschenen in_ [Delf, cultuurhistorisch magazine voor Delft](https://delfia-batavorum.nl/publicaties/delf)_, jaargang 23, no. 1, maart 2022._

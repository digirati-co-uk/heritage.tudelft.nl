...
export function CollectionCard({ collection }: { collection: Collection["items"][number] }) {
  const t = useTranslations();
  const summary =
    collection.metadata?.find((item) => item.label.en?.includes("Short description"))?.value ?? collection.summary;

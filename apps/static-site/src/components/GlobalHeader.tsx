    ...
    <div className="flex justify-center bg-[#1D1F71] font-mono text-white">
      <div className="flex h-16 w-full max-w-screen-xl items-center px-10 py-2">
        ...
        <ul className="ml-auto flex items-center gap-5">
          ...
          <li>
            <Link className="text-md uppercase underline-offset-4 hover:underline" href="/publications">
              {t("Publications")}
            </Link>
          </li>
          <li>
            <Link className="text-md uppercase underline-offset-4 hover:underline" href="/about">
              {t("About")}
            </Link>
          </li>
          <li>
            <Link className="text-md uppercase" href="/search">
              <div className="transition-background duration-400 flex h-10 w-10 items-center justify-center rounded-full border border-white text-white hover:bg-black">

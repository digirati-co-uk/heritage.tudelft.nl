...
export function ImageBlockPresentation({ canvas, objectLinks, ...props }: ImageBlockProps & BaseSlideProps) {
  ...
  return (
    <BaseSlide className={"mb-8 bg-black"} index={props.index} active={props.active}>
